...
# Tries to get the ID of a hero, if not found returns -1
def getHeroID(heroName):
    try:
        heroID = next(hero for hero in heroes if hero['localized_name'] == heroName)
        return heroID['id']
    except:
        print('Hero', inpt, 'not found.')
        return -1

# List of Heroes and their respective names and IDs
# Credit to Greg Schafer for creating this list
